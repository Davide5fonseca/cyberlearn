...
export default function Sidebar({ view, setView, handleLogout, theme, user, isMobile }) {
  ...
  // ESTADO MODAL DE CONFIRMAÇÃO DE LOGOUT
  ...
  const styles = {
    ...
    menuItem: (active) => ({
      ...
      alignItems: 'center',
      gap: '12px',
      color: active ? theme.textMain : theme.textSub,
      background: active ? `linear-gradient(135deg, ${theme.primary}26, ${theme.accent}14)` : 'transparent',
