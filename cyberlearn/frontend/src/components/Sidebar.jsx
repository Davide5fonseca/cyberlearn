export default function Sidebar({ view, setView, handleLogout, theme, user }) {
  // Verifica se o utilizador atual é professor
  ...
  const styles = {
    ...
    shieldIcon: { backgroundColor: theme.primary, width: '35px', height: '35px', borderRadius: '8px', marginBottom: 0, display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: `0 0 20px ${theme.primary}80` }
  };
        ...
        {isProfessor ? (
          <>
            <div style={styles.menuItem(view === 'professor_dashboard')} onClick={() => setView('professor_dashboard')}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg> Painel Geral
            </div>
            <div style={styles.menuItem(false)} onClick={() => alert('Em breve: Gestão de Cursos')}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"></path><path d="M6 12v5c3 3 9 3 12 0v-5"></path></svg> Gerir Cursos
            </div>
            <div style={styles.menuItem(false)} onClick={() => alert('Em breve: Lista de Alunos')}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> Alunos
            </div>
          </>
        ) : (
          /* MENU DO ALUNO */
